<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\phpStudy\WWW\2018.10.18\public/../app/admin\view\rbac\index.html";i:1508120513;s:68:"D:\phpStudy\WWW\2018.10.18\public/../app/admin\view\common\base.html";i:1508120513;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="utf-8">
...
<div class="container-fluid main">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="<?php echo url('rbac/index'); ?>" class="index-url">角色列表</a></li>
	...
	<table class="table table-bordered table-hover top10">
		...
		<?php if(is_array($rolelists) || $rolelists instanceof \think\Collection || $rolelists instanceof \think\Paginator): $i = 0; $__LIST__ = $rolelists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vorole): $mod = ($i % 2 );++$i;?>
			<tr>
				<td><?php echo $vorole['id']; ?></td>
				<td><?php echo $vorole['name']; ?></td>
				<td><?php echo $vorole['remark']; ?></td>
				<td style="text-align: center;">
					<?php if($vorole['status'] == '1'): ?>
				...
				<td style="text-align: center;">
					<?php if($vorole['id'] == '1'): ?>
						<a class="btn btn-default btn-xs">权限设置</a>
						<a class="btn btn-default btn-xs left10">编辑</a>
						<a class="btn btn-default btn-xs left10">删除</a>
					<?php else: ?>
						<a href="<?php echo url('rbac/authorize', array('id' => $vorole['id'])); ?>" class="btn btn-warning btn-xs">权限设置</a>
						<a href="<?php echo url('rbac/edit', array('id' => $vorole['id'])); ?>" class="btn btn-info btn-xs left10">编辑</a>
