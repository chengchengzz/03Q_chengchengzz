<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\phpStudy\WWW\2018.10.18\public/../app/admin\view\slideseat\index.html";i:1508120513;s:68:"D:\phpStudy\WWW\2018.10.18\public/../app/admin\view\common\base.html";i:1508120513;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="utf-8">
...
<div class="container-fluid main">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="<?php echo url('slideseat/index'); ?>" class="index-url">幻灯片分类列表</a></li>
		<li><a href="<?php echo url('slideseat/add'); ?>">新增幻灯片分类</a></li>
	</ul>
	...
	<table class="table table-bordered table-hover top10">
		...
		<?php if(is_array($slideseatlists) || $slideseatlists instanceof \think\Collection || $slideseatlists instanceof \think\Paginator): $i = 0; $__LIST__ = $slideseatlists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voslideseat): $mod = ($i % 2 );++$i;?>
			<tr>
				<td><?php echo $voslideseat['id']; ?></td>
				<td><?php echo $voslideseat['title']; ?></td>
				<td style="text-align: center;">
					<a href="<?php echo url('slideseat/edit', array('id' => $voslideseat['id'])); ?>" class="btn btn-warning btn-xs">编辑</a>
					<a class="btn btn-danger btn-xs left10 btn-deletes" data-url="<?php echo url('slideseat/deletes'); ?>" data-id="<?php echo $voslideseat['id']; ?>">删除</a>
				</td>
			</tr>
