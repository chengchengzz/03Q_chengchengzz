<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\phpStudy\WWW\2018.10.18\public/../app/admin\view\users\add.html";i:1508120513;s:68:"D:\phpStudy\WWW\2018.10.18\public/../app/admin\view\common\base.html";i:1508120513;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="utf-8">
...
<div class="container-fluid main">
	...
	<ul class="nav nav-tabs">
		<li><a href="<?php echo url('users/index'); ?>" class="index-url">用户列表</a></li>
		<li class="active"><a href="<?php echo url('users/add'); ?>">新增用户</a></li>
	</ul>
	
	<form name="dataForm" class="form-horizontal top15" action="<?php echo url('users/addsave'); ?>">
		<div class="form-group">
			<label class="col-sm-3 control-label"><span class="must-red">*</span> 用户名</label>
			<div class="col-sm-8">
				<input type="text" name="name" class="form-control width300">
				<span class="help-block">用户名用于登陆，仅限英文字符 + 数字</span>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-3 control-label"><span class="must-red">*</span> 昵称</label>
			<div class="col-sm-8">
				<input type="text" name="nickname" class="form-control width300">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-3 control-label"><span class="must-red">*</span> 密码</label>
			<div class="col-sm-8">
				<input type="text" name="passwd" class="form-control width300">
				<span class="help-block">密码长度不能小于 6 位字符长度</span>
			</div>
		</div>
		<div class="form-group">
