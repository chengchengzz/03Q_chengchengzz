...
class Base extends Controller {
    ...
    public $session_id;
    public $is_eyou_authortoken = 1; // 默认是
    ...
    function __construct() 
    {
        ...
        /*---------*/
        $this->is_eyou_authortoken = session('is_eyou_authortoken');//
        extra_cache('global_is_eyou_authortoken', $this->is_eyou_authortoken);
        $this->assign('is_eyou_authortoken', $this->is_eyou_authortoken);
        /*--end*/
