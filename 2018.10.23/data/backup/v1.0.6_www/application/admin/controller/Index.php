...
class Index extends Base
{
    ...
    public function welcome()
    {
        /*PC端外观调试入口*/
        $uiset_pc_url = '';
        if (file_exists(ROOT_PATH.'template/pc')) {
            $uiset_pc_url = url(MODULE_NAME.'/Uiset/pc', array(), true, SITE_URL);
        }
        /*--end*/
        $this->assign('uiset_pc_url',$uiset_pc_url);
    ...
    public function authortoken()
    {
        ...
        if (IS_POST) {
            ...
            if ($result) {
                ...
                adminLog('录入商业授权');
                $this->success("授权成功!", U('Index/welcome'));
            }else{
                $this->error("授权失败!", U('Index/authortoken'));
            }
            exit;
        }
    ...
    {
        $html = '<div style="text-align: center; margin: 20px 0px; color:red;">没啥好看，惹妹子生气了！</div>';
        echo $html;
    }
